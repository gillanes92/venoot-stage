    ...
    <table bgcolor="#e0e0e0" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" style="border-collapse:collapse;">
      <tr>
        <td><center style="width: 100%;">
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center"><img src={{ Storage::url($event->logo_event) }} width="200" height="50" alt="alt_text" title="Logo Empresa" border="0"></td>
              </tr>
          </table>
            <!-- Email Header : END -->
			...
			<tr>
                ...
                <div>
                    ...
                    <tr>
                        <td valign="middle" align="center" style="padding: 20px; font-family: sans-serif; font-size: 12px; mso-height-rule: exactly; line-height: 20px; color: #666;"><p><p><label>{{$start_date->format('d') }}{{$start_date->day != $end_date->day ? ' a '.$end_date->format('d') : '' }} {{$start_date->locale('es')->monthName }}{{$start_date->month != $end_date->month ? ' a '.$end_date->locale('es')->monthName : '' }}</label><br><label>Lugar: {{ $event->location }}</label><br><label>Desde las {{ $start_time->format('H:i') }}Hrs.</label></p></td>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                                <tr>
                                  <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                        <a href="{{ url("events/{$event->id}/landing") }}?qr={{ $uuid }}"
				...
				<div>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
                        <td colspan="2" valign="middle"><div class="heading-section-blanco"><span class="subheading">DATOS DEL PARTICIPANTE</span></div></td>
                    </tr>
					<tr>
                ...
                @if ($event->estimate->app)
                <div>
                    <br><br><br>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 100%;">
					<tr>
                        <td colspan="2" valign="middle"><div class="heading-section-blanco"><span class="subheading">INGRESE A NUESTRO APP</span></div></td>
                    </tr>
					<tr>
                        <td colspan="2"class="full-width-image" style="width: 100%;"><center><img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(400)->generate($participant->data['email'])) !!} " width="600" alt="CodigoQR" border="0" style="width: 100%; max-width: 300px; height: auto; margin: 5px;" title="CodigoQR"></center></td>
                    </tr>
                  </table>
                </div>
                @endif
