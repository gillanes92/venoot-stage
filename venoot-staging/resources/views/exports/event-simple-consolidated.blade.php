<html>
    ...
    <table>
        ...
        <tr>
            ...
            @if ($sold_ticket->participation)
                <td>{{ $sold_ticket->participation->confirmed_status ? 'SI' : 'NO' }} - {{ $sold_ticket->participation->confirmed_at }}</td>
                <td>{{ $sold_ticket->participation->registered_at }}</td>
            @endif
        </tr>
