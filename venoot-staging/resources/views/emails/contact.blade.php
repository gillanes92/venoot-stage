    ...
    <td><center style="width: 100%;">
        ...
        <div style="max-width: 600px;">
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td class="full-width-image" align="center" height="100px" style="background-color: black;" ><img src="{{ url('/images/v-venoot.png') }}"></td>
            </tr>
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0" border="0" width="100%">
				  <tr>
				  <td style="padding: 30px 0px 5px 0px; font-family: sans-serif; font-size: 24px; mso-height-rule: exactly; color: #555555; text-align: center">Contacto Correo Electrónico</td>
				  </tr>
                  <tr>
