                                                ...
                                                >
                                                        ...
                                                        @foreach($fields as $field)
                                                            <tr>
                                                                ...
                                                                @elseif($field['type'] == 'pdf')
                                                                    <td>
                                                                        <a
                                                                            href="{{ Storage::url($participant->data[$field['key']]) }}"
                                                                            target="_blank"
                                                                        >
                                                                            PDF
                                                                        </a>
                                                    ...
                                                    >
                                                         <tr>
                                                            ...
                                                            >
                                                                <a
                                                                    href="{{ url("databases/{$database->id}/events/{$event->id}/{$participant->data['uuid']}/accept") }}"
                                                        ...
                                                        <tr>
                                                                ...
                                                                >
                                                                    <a
                                                                        href="{{ url("databases/{$database->id}/events/{$event->id}/{$participant->data['uuid']}/reject") }}"
                                                                        style="background: #222222; border: 15px solid #222222; padding: 0 10px; color: #ffffff; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;"
                                                                        class="button-a"
                                                                    >
                                                                        RECHAZAR
