                        ...
                        >
                            <tr>
                                <td style="padding: 20px 0; text-align: center">
                                    <img
                                        src="{{ url('/storage/'.$event->logo_event ) }}"
                                        width="200"
                                        height="50"
                                        alt="alt_text"
                                        border="0"
                        ...
                        >
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    siguiente email podrás descargar el QR
                                    asociado a tu acceso al evento, presiona
                            ...
                            <tr>
                                <td
                                    background="{{ url('/storage/'.$event->banner ) }}"
                                    bgcolor="#222222"
                                    valign="middle"
