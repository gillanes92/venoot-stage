...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#e0e0e0" style="border-collapse:collapse;">
  <tr>
    <td><center style="width: 100%;">
        ...
        {{-- <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> (* opcional) Este texto es el preview que aparecería en los inbox </div> --}}
        ...
        <div style="max-width: 600px;">
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
            <tr>
              <td style="padding: 20px 0; text-align: center"><img src={{ Storage::url($event->logo_event) }} width="200" height="50" alt="alt_text" border="0"></td>
            </tr>
          </table>
          <!-- Email Header : END -->
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="100%" style="max-width: 600px;">
            ...
            <tr>
              <td class="full-width-image" align="center" ><img src={{ Storage::url($event->banner) }} width="600" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto;"></td>
            </tr>
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0" border="0" width="100%">
				  <tr>
				  <td style="padding: 30px 0px 5px 0px; font-family: sans-serif; font-size: 24px; mso-height-rule: exactly; color: #555555; text-align: center">{{ $event->name }}</td>
				  </tr>
                  <tr>
                  <td style="padding: 30px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; text-align: center"> Estimado {{ $participant->data['name'] }}  {{ $participant->data['lastname'] }} has sido invitado al siguiente evento que se celebrará el {{ $start_date->isoFormat('dddd, DD [de] MMMM [de] YYYY') }}, a las {{ $start_time->isoFormat('HH:mm') }} en <a href="https://www.google.com/maps/place/{{ $event->location }}" target="_blank">{{ $event->location }}</a> <br><br>

                    @if ($event->estimate->confirmation_form)
                        <p>Requerimos de tu confirmación, para esto debes solamente presionar el botón Confirmo Asistencia.</p>
                    @elseif($event->estimate->ticket_sale)
                        <p>Visita nuestra pagina para comprar tus entradas!</p>
                    @endif
                    <br><br>
                      ...
                      <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                        <tr>
                          <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                <a href="{{ url("events/{$event->id}/landing") }}"
                                style="background: #222222; border: 15px solid #222222; padding: 0 10px; color: #ffffff; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;"
                                class="button-a"
                                >
                                    Ir al Evento
              ...
              <td style="padding: 40px 10px;width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #888888;">
                @if ($event->landing)
                    <webversion style="color:#cccccc; text-decoration:underline; font-weight: bold;">
                        <a href="{{ url("events/{$event->id}/landing") }}">Ir al Evento</a>
                    </webversion>
                @endif
                <br>
                <br>
