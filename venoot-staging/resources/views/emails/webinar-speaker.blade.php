    ...
    <div builder-element="BlockElement" builder-container="" builder-wrapper="" class="container">
        ...
        <div builder-element="BlockElement" builder-draggable="" class="py-3 px-3">
            <h1 builder-element="" builder-inline-edit="" class="display-4 text-center" id="mce_17"
                style="position: relative;" spellcheck="false">Acceso Speaker</h1>
            <h5 builder-element="" builder-inline-edit="" class="text-center font-weight-normal mt-1 mb-3 text-muted"
                id="mce_18" style="position: relative; color: {{ $event->secondary }};" spellcheck="false">{{ $event->name }}</h5>
        ...
        <div builder-element="BlockElement" builder-draggable="" class="py-3 px-3 row" style="">
            <div class="col-md-6" style="text-align: center;">
                <img builder-element="" builder-inline-edit="" class="my-2 image-after-change"
                    src="https://venoot-stage.work/public/images/fpaMAH73zclsf4oyOVTSF50CgIzK5hEypn0TtL4N.png" ;
                    style="width: 300px; height: 281px; margin: auto;" width="100%">


            </div>
            <div class="col-md-6">
                <p builder-element="" builder-inline-edit="" class="" id="mce_19"
                    style="position: relative; margin-top: 30px;" spellcheck="false">Fuiste invitado como charlista al
                    evento {{ $event->name }}, para poder acceder al panel de transmisión debes hacer click en el enlace
                    disponible en este correo.</p>
        ...
        <div builder-element="BlockElement" builder-draggable="" class="px-3 my-3" style="">
            <div class="text-center">
                <button builder-element="" builder-inline-edit="" class="btn btn-danger btn-lg mr-2" id="mce_16"
                    style="position: relative; background-color: {{ $event->primary }};" spellcheck="false"><a href="{{ $event->presenter_webinar_link }}" style="color: #FFFFFF">Ir al Evento</a></button>
            </div>
        </div>
                ...
                <div class="row center">
                    <div builder-element="" builder-inline-edit="" class="col-md-12" id="mce_20" spellcheck="false">
                        <p class="mb-0" style="text-align: center;"><br><span style="font-size: 12px;">Este email fue
                                enviado a nombre de <a href="mailto:{{ $user->email }}">{{ $user->email }}</a>. </span><br><span
                                style="font-size: 12px;">Revisa nuestras <a
