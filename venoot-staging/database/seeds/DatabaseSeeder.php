...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $client = new Client();
        // $countryQuery = $client->get('http://battuta.medunes.net/api/country/all/?key=276ee109769b079e3518bdbd08c7748b');
        // $countries = $countryQuery->getBody();
        // $countries = json_decode($countries, true);
        // foreach ($countries as $country) {
        //     $c = \App\Models\Region::create(['name' => $country['name'], 'code' => $country['code']]);

        //     $regionsQuery = $client->get('http://battuta.medunes.net/api/region/'.$country['code'].'/all/?key=276ee109769b079e3518bdbd08c7748b');
        //     $regions = $regionsQuery->getBody();
        //     $regions = json_decode($regions, true);

        //     foreach ($regions as $region) {
        //         $r = \App\Models\Commune::create(['name' => $region['name'], 'region_id' => $c->id]);

        //         $citiesQuery = $client->get('http://battuta.medunes.net/api/city/search/?region={REGION_NAME_HINT}&city={CITY_NAME_HINT}&key={YOUR_API_KEY}');
        //         $cities = $citiesQuery->getBody();
