...
class WebinarSpeaker extends Mailable
{
  use Queueable, SerializesModels;

  public $category = 'WebinarPresenterEventLink';
  public $user;
  public $event;
  public $participant;
   ...
   * @return void
   */
  public function __construct(Event $event, Request $request, $fromName = null, $subject = null)
  {
    $this->user = Auth::user();
    $this->event = $event;
  ...
  public function build()
  {
    ...
    return $this->view('emails.webinar-speaker')
      ->subject('Webinar Speaker Mail');
  }
}
