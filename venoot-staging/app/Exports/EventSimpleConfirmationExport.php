...
class EventSimpleConfirmationExport implements FromView, WithTitle, ShouldAutoSize, WithEvents, WithColumnFormatting
{
    use Exportable;
    ...
    {
        $this->event = $event;
        $this->participations = $event->participations()->with('participant')->get();
    }
    ...
    {
        return view('exports.event-simple-confirmation', [
            'event' => $this->event,
